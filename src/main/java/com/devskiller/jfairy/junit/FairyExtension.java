...
public class FairyExtension implements ParameterResolver, TestInstancePostProcessor {
    ...
    private static final List<ObjectProvider> providers = List.of(new BooleanProvider(), new IntegerProvider(), new StringProvider(), new EnumProvider(), new PersonProvider(), new CompanyProvider(), new AddressProvider(), new FairyProvider());
